...
ActiveRecord::Schema.define(version: 2022_09_21_023657) do
  ...
  create_table "purchase_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_management_id"], name: "index_purchase_infos_on_purchase_management_id"
  end
  ...
  add_foreign_key "purchase_infos", "purchase_managements"
